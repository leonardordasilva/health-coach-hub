                      ...
                      <TableRow key={user.id} className="hover:bg-muted/30">
                        ...
                        <TableCell>
                          {user.is_default_password ? (
                            ...
                            <Badge variant="outline" className="text-success border-success/30 bg-success-light text-xs">
                              Ativo
                            </Badge>
                          )}
                        </TableCell>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{formatDate(selectedUser.birth_date)}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{selectedUser.weight ? `${selectedUser.weight} kg` : "—"}</p>
                    </div>
                  </div>
                </div>
